...
{
    public class IntersectOperation<T> : OctreeNodeOperation<T>
    {
        /*
         *       b
         *    |E|F|P
        ...
        {
            return new OctreeNode<T>(a.Center, a.Size, new OctreeNode<T>(a.Center, a.Size, a.CreateChildren(NodeState.Filled), a.Level, a.MaxLevel).Children.Zip(b.Children, new IntersectOperation<T>().Run).ToArray(), a.Level, a.MaxLevel);
        }
        ...
        {
            return new OctreeNode<T>(a.Center, a.Size, a.Children.Zip(b.Children, new IntersectOperation<T>().Run).ToArray(), a.Level, a.MaxLevel);
        }
    }
}